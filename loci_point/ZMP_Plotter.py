...
def ZMP_Plotter(df_plt, save_o_TOV, p_show_TOV, fig_name, is_j, max_time):
    """
            Function returns dataframe with mapped values.
        """
    ...
    #     # plt.axis(xmin=int(0), xmax=(500), ymin=int(-8), ymax=int(8))
    else:
    ...
    if is_j:
        plot_name = fig_name + '_j_Bus_Short' + constants.plotting.figure_type
    else:
        plot_name = fig_name + '_i_Bus_Short' + constants.plotting.figure_type
...
def TOV_SC_Runner(TOV_List, object_Name, output_name, is_pow, TOV_Limit, plot_TOV, save_o_TOV, p_show_TOV,
    ...
    """
    if first_col_in:
        TOV_header_List = constants.Digsilent.ZMP_header_list
    else:
        TOV_header_List = constants.Digsilent.ZMP_header_list_no_fc
    ...
    for i in range(0, len(csv_List)):
        ...
        scan_df_1 = CSV_reader_df_maker_General(csv_name=csv_List[i],
...
if __name__ == '__main__':
    ...
    TOV_List = ['W_PRF_B_0', 'W_PRF_A_0','W_PRF_C_0','D_PRF_B_0', 'D_PRF_A_0','D_PRF_C_0','D_PRF_A_Peak','W_PRF_A_Peak']
